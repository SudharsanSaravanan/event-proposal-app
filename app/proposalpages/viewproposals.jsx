  ...
  return (
    <div className="h-screen bg-gray-900 text-white flex flex-col">
      ...
      <div className="p-6 pb-4">
        <h1 className="text-3xl font-bold text-center">Your Proposals</h1>
      </div>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start mb-3">
                  ...
                  <button 
                    ...
                    className="bg-blue-600 text-white px-4 py-1 rounded-md text-sm hover:bg-blue-700 transition w-full sm:w-auto sm:ml-2"
                  >
                    Edit
                  </button>
                </div>
