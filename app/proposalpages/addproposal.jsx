...
export default function AddProposalContent() {
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      // The setTimeout and router.push have been removed
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center space-x-4">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <FormLabel className="text-white">Workshop</FormLabel>
                        </div>
                      </FormItem>
                    )}
                  />
                    ...
                    render={({ field }) => (
                      <FormItem className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          ...
                          <FormLabel className="text-white">Technical</FormLabel>
                        </div>
                        <div className="flex items-center space-x-2">
                          <FormControl>
                            <Checkbox
                          ...
                          <FormLabel className="text-white">Non-Technical</FormLabel>
                        </div>
                      </FormItem>
                    )}
                  />
