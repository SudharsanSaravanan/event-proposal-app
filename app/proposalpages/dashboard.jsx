            ...
            <div className='max-w-4xl mx-auto p-6'>
                ...
                <div className='bg-gray-800 p-6 rounded-lg shadow-lg mb-8'>
                    ...
                    <p className='text-gray-300'>
                        This platform enables you to submit and manage proposals for workshops and
                        events. Create compelling proposals, track their review progress, and
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-6 mb-8'>
                    ...
                    >
                        ...
                        <p className='text-gray-300 text-sm'>
                            Submit a detailed proposal for technical workshops, training sessions,
