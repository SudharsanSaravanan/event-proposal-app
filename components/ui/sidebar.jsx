...
function Sidebar({
    ...
    // In the Sidebar component, modify the isMobile part:
    if (isMobile) {
        return (
            <div data-slot='sidebar' {...props}>
                {openMobile && (
                    <div
                        ...
                        className={cn(
                            ...
                            side === 'left'
                                ? 'left-2 top-[var(--header-height)]'
                                : 'right-2 top-[var(--header-height)]' // Position below the header/top bar
                        )}
                ...
                <div
                    ...
                    onClick={() => setOpenMobile(false)} // Close menu when clicking outside
                />
            </div>
        );
    }
